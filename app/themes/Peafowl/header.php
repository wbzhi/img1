                    ...
                    <ul class="top-bar-left float-left">
                        ...
                        <?php if (CHV\getSetting('website_random')) {
                            ...
                            <li id="top-bar-random" data-nav="random" class="top-btn-el">
                                <a href="<?php echo G\get_base_url('?random'); ?>"><span class="top-btn-text"><span class="icon icon-shuffle"></span><span class="btnphablet-hide"><?php _se('Random'); ?></span></span></a>
            </li>
			<?php
                } ?>
            <?php { ?>
            <li class="top-btn-el">
            	<a href="https://img.wang/page/tos"><span class="top-btn-text"><span class="icon icon-text"></span><span class="btn-text phone-hide phablet-hide"><?php _se('服务条款'); ?></span></span></a>
            </li>
            <li class="top-btn-el">
            	<a href="https://img.wang/page/shang"><span class="top-btn-text"><span class="icon icon-thumbs-up"></span><span class="btn-text phone-hide phablet-hide"><?php _se('赞助'); ?></span></span></a>
            </li>
            <?php } ?>
