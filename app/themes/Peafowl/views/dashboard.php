...
function read_the_docs($args = [])
{
    return _s('Learn more about %s at our %d.', [
        '%s' => $args['%s'],
        '%d' => '<a href="https://301.es/?https://chevereto.com/docs/' . $args['%k'] . '" target="_blank">' . _s('documentation') . '</a>',
    ]);
}
?>
	...
	<div class="form-content">
        ...
        ?>
			...
			<?php if (get_settings()['key'] == 'routing') {
                            ?>
			<p><?php _se('Routing allows you to customize default route binds on the fly. Only alphanumeric, hyphen and underscore characters are allowed. Check out our %s if you want to override or add new routes.', '<a href="https://301.es/?https://chevereto.com/docs/routes">' . _s('documentation') . '</a>'); ?></p>
			<div class="input-label">
