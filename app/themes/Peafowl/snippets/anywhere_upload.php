				...
				<div data-group="upload-queue-ready">
					...
					<?php
                        if (CHV\getSetting('theme_nsfw_upload_checkbox')) {
                            ?>
                    <div class="margin-10"><span rel="tooltip" data-tiptip="top" title="<?php _se('标记该图片不适合在公共场合浏览'); ?>"><input type="checkbox" name="upload-nsfw" id="upload-nsfw" class="margin-right-5" value="1"><label for="upload-nsfw"><?php _se('标记为 NSFW'); ?></label></span></div>
					<?php
                        }
                    ?>
