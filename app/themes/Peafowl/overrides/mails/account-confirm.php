...
<div style="width: 550px;height: auto;border-radius: 5px;margin:0 auto;border:1px solid #666;box-shadow: 0px 0px 20px #888888;position: relative;padding-bottom: 5px;">
    ...
    <div style="width: 200px;height: 40px;background-color: #00A7DA;margin-top: -20px;margin-left: 20px;box-shadow: 3px 3px 3px rgba(0, 0, 0, 0.3);color: rgb(255, 255, 255);text-align: center;line-height: 40px;">Dear: <a style="text-decoration:none;color:#FFF;" href="{$body_arr['Userlink']}" rel="noopener" target="_blank">{$body_arr['Username']}</a></div>
    <div style="background-color:white;line-height:180%;padding:0 15px 12px;width:520px;margin:30px auto;color:#555555;font-family:'Century Gothic','Trebuchet MS','Hiragino Sans GB',微软雅黑,'Microsoft Yahei',Tahoma,Helvetica,Arial,'SimSun',sans-serif;font-size:12px;margin-bottom: 0px;">  
        <h2 style="border-bottom:1px solid #DDD;font-size:14px;font-weight:normal;padding:13px 0 10px 8px;"><span style="color: #12ADDB;font-weight: bold;">&gt; </span>我们收到了您在<a style="text-decoration:none;color: #12ADDB;" href="{$body_arr['URL']}" target="_blank" rel="noopener">《{$body_arr['Web_name']}》</a>提交的注册请求。</h2>  
    ...
    <a style="text-decoration:none; color:#FFF;width: 40%;text-align: center;background-color:#00A7DA;height: 40px;line-height: 35px;box-shadow: 3px 3px 3px rgba(0, 0, 0, 0.30);margin: -10px auto;display: block;" href="{$body_arr['Link']}" target="_blank" rel="noopener">点我激活您的账户</a>
    <div style="background-color:white;line-height:180%;padding:0 15px 12px;width:520px;margin:30px auto;color:#555555;font-family:'Century Gothic','Trebuchet MS','Hiragino Sans GB',微软雅黑,'Microsoft Yahei',Tahoma,Helvetica,Arial,'SimSun',sans-serif;font-size:12px;margin-bottom: 0px;">
